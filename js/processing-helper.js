(function(global) {
  ...
  var canvas = document.getElementById('modsketch_sketch'),
  ...
  function createCanvas() {
    ...
    var container = document.getElementById('modsketch_container');
    var sketch = document.getElementById('modsketch_sketch');
    container.removeChild(sketch);

    sketch = document.createElement('canvas');
    sketch.id = 'modsketch_sketch';
